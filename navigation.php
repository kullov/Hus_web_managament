    ...
    <div class="w3-container w3-bar w3-black w3-theme-d2 w3-left-align">
      ...
      <!-- <div class="w3-dropdown-hover w3-mobile"> -->
        ...
        <!-- <div class="w3-dropdown-content w3-bar-block w3-dark-grey" > -->
          ...
          <a href="/web_management/scr_100x/student/scr_1001/scr_1001V.php" class="w3-padding-16 w3-bar-item w3-button w3-hide-small w3-hover-white <?php if (($_SESSION["role"]) == "") { ?> w3-hide <?php }?> ">Detail Recruit Form</a>
        <!-- </div> -->
      <!-- </div> -->
