      ...
      <div class="login-form w3-row ">
        ...
        <div class="w3-col s4">
          <div class="form-group <?php echo (!empty($join_date_err)) ? 'has-error' : ''; ?>">
            ...
            <input placeholder="Enter join date" type="password" name="join_date" class="form-control" value="<?php echo $join_date; ?>" required>
          </div>
        ...
        <div class="w3-col s4">
          ...
          <div class="form-group <?php echo (!empty($date_of_birth_err)) ? 'has-error' : ''; ?>">
            ...
            <input type="date" placeholder="Enter your birth day" name="date_of_birth" value="<?php echo $date_of_birth; ?>">
          </div>
