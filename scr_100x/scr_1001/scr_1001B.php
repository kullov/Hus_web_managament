        ...
        while($row = $result->fetch_assoc()) {
          ...
          <div class="w3-third w3-container w3-margin-bottom w3-card">
            ...
            <div class="w3-white" style="height: 38px;">
              <form action="scr_1001V.php?id='.$row['id'].'" method="post">
                <button type="submit" name="detailBtnSmt" class="w3-button w3-right w3-green">Chi tiết</button>
              </form>
              <form action="scr_1001A.php?id='.$row['id'].'" method="post">
                <button type="submit" name="registerBtnSmt" class="w3-button w3-left w3-blue '; 
                if (($_SESSION["role"]) !== "student") { echo 'w3-hide'; }; 
                echo ' ">Đăng kí</button></a>	
              </form>
            </div>
          </div>';
        }
