...
<a href="/demo-project/scr_100x/student/scr_1001.php" class="w3-bar-item w3-button w3-mobile w3-padding-16 <?php if (($_SESSION["role"]) !== "student") { ?> w3-hide <?php }?> " >Student</a>
          <a href="/demo-project/scr_100x/organization/scr_1002.php" class="w3-bar-item w3-button w3-mobile w3-padding-16 <?php if (($_SESSION["role"]) !== "organization") { ?> w3-hide <?php }?> ">Company</a>
          <a href="/demo-project/scr_100x/teacher/scr_1003.php" class="w3-bar-item w3-button w3-mobile w3-padding-16 <?php if (($_SESSION["role"]) !== "teacher") { ?> w3-hide <?php }?> ">Teacher</a>
        <!-- </div> -->
      <!-- </div> -->
